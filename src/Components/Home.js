...
const Home = () => {
    ...
    const {profile,user,friend1,friend2,timer,follow}=UseHooks();
   let post1,post2
 ...
 const handleDelete3=(indexVal)=>{
  ...
  return (
    <div className=''>
        <div className="container-fluid bg-black ">
            ...
            <div className="row">
                <div className="col-md-1 col-xxl-2 col-xl-2 d-flex  border-end border-secondary  flex-column pt-3 d-none d-md-block" id='Left-content'>
                    ...
                    <div className="row ">
                        ...
                        <i className="bi bi-compass text-white  "></i>
                            <span className='text-white ms-2 d-none d-xl-block'>Explore</span>      
                        </button>
                        <button className="btn d-flex  mb-1 mt-1">
                        <i className="bi bi-film text-white "></i>
                            <span className='text-white ms-2 d-none d-xl-block'>Reels</span>      
                        </button>
                        <button className="btn   d-flex mb-1 mt-1 ">
                            <i className="bi bi-chat-left-dots text-white "></i>
                            <span className='text-white ms-2 d-none d-xl-block'>Messages</span>      
                        </button>
                        <button className="btn d-flex mb-1 mt-1 " id='heart'>
                            <i className="bi bi-heart text-white "></i>
                            <span className='text-white ms-2 d-none d-xl-block'>Notification</span>      
                        </button>
                        <button className="btn   d-flex  mb-1 mt-1" data-bs-toggle="modal" href="#createPost" role='button'>
                ...
                <div className="row d-xs-block d-md-none position-fixed  w-100  border-bottom bg-black ">
    ...
    <div className="col-md-7   p-1 mt-3" id='post4' >
                   ...
                   <div className="row d-xs-block d-md-none position-fixed  bottom-0 bg-black justify-content-center w-100 border border-top">
